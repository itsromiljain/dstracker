...
const getAllProjects = () => {
  try {
    return new Promise((resolve, reject) => {
      axios.get('http://192.168.43.167:7020/tracker/')
      .then((response) => {
...
const getAllsupply = () => {
  try {
    return new Promise((resolve, reject) => {
      axios.get('http://192.168.43.167:7020/getAllsupply/')
      .then((response) => {
        return resolve(response)
      })
      .catch((error) => {
...
//   try {
//     return new Promise((resolve, reject) => {
//       axios.get('http://192.168.43.167:7020/api/skill')
//       .then((response) => {
//         return resolve(response)
//       })
//       .catch((error) => {
...
//   try {
//     return new Promise((resolve, reject) => {
//       axios.get('http://192.168.43.167:7020/invoicefb/')
//       .then((response) => {
//         return resolve(response)
//       })
//       .catch((error) => {
...
//   try {
//     return new Promise((resolve, reject) =>{
//       axios.get('http://192.168.43.167:7020/imts/')
//       .then((response) => {
//         return resolve(response)
//       })
//       .catch((error) => {
...
//   try {
//     return new Promise((resolve, reject) =>{
//       axios.get('http://192.168.43.167:7020/applemgr/')
//       .then((response) => {
...
//   try {
//     return new Promise((resolve, reject) =>{
//       axios.get('http://192.168.43.167:7020/getAllapplel1mgr/')
//       .then((response) => {
//         console.log(response.data)
//         return resolve(response)
//       })
...
const getAppleL2Manager = () => {
  try {
    return new Promise((resolve, reject) =>{
      axios.get('http://192.168.43.167:7020/getAllapplel2mgr/')
      .then((response) => {
        console.log(response.data)
        return resolve(response)
      })
...
const get_manag = () => {
  try {
    return new Promise((resolve, reject) => {
      axios.get('http://192.168.43.167:7020/deliverymgr/')
      .then((response)=> {
        return resolve(response)
      })
      .catch((error) => {
...
const getSingleProject = (query) => {
  ...
  try {
    return new Promise((resolve, reject) => {
      axios.get(`http://192.168.43.167:7020/tracker/${id}`)
      .then((response) => {
        return resolve(response)
      })
      .catch((error) => {
...
const getSkill_Project = (query) => {
  ...
  try {
    return new Promise((resolve, reject) => {
      axios.get(`http://192.168.43.167:7020/api/skill/${psno}`)
      .then((response) => {
        return resolve(response)
      })
      .catch((error) => {
...
const getInvoice_qury = (query) => {
  ...
  try {
    return new Promise((resolve, reject) => {
      axios.get(`http://192.168.43.167:7020/invoicetm/${sow}`)
      .then((response) => {
        return resolve(response)
      })
      .catch((error) => {
...
const getFb_qury = (query) => {
  ...
  try {
    return new Promise((resolve, reject) => {
      axios.get(`http://192.168.43.167:7020/invoicefb/${poNo}`)
      .then((response) => {
        return resolve(response)
      })
      .catch((error) => {
...
const setProject = (data) => {
  try {
    return new Promise((resolve, reject) => {
      axios.post('http://192.168.43.167:7020/tracker', data, {
        headers: {
...
const setSupply = (data) => {
  try {
    return new Promise((resolve, reject) => {
      axios.post('http://192.168.43.167:7020/supply', data, {
        headers: {
          'Content-Type': 'application/json',
        }
      })
...
const skill_set = (data) => {
  try {
    return new Promise((resolve, reject) => {
      axios.post('http://192.168.43.167:7020/api/skill', data, {
        headers: {
          'Content-Type': 'application/json',
        }
      })
...
const Invoice_set = (data) => {
  try {
    return new Promise((resolve, reject) => {
      axios.post('http://192.168.43.167:7020/invoicetm/', data, {
        headers: {
          'Content-Type': 'application/json',
        }
      })
...
const Fb_set = (data) => {
  try {
    return new Promise((resolve, reject) => {
      axios.post('http://192.168.43.167:7020/invoicefb/', data, {
        headers: {
          'Content-Type': 'application/json',
        }
      })
